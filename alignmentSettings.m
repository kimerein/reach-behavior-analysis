...
settings.fractionThroughArduino=0.72; 
if ~isempty(varargin)
...
settings.try_scale1=0.03;
settings.try_scale2=0.06;  
if ~isempty(varargin)
    if length(varargin)>4
        temp=varargin{5};
        settings.tryinc=temp(1);
        settings.try_scale1=temp(2);
        settings.try_scale2=temp(3);
    end
end
