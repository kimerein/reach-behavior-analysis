...
movieframeinds=alignDataLikeMovie(movieframeinds_raw,movie_dec,frontShift,shouldBeLength,movieToLength,alignSegments,segmentInds,segmentDelays,addZeros_movie,scaleBy,resampFac,moveChunks,guess_best_scale1);
...
rescaled_thresh=0.5;
deriv_LEDvals_rescaled=[diff(double(aligned.movie_distractor>0.2)) 0];
