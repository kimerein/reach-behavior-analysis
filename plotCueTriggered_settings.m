...
settings.blockITIThresh=[200]; % boundaries between ITI block lengths, in seconds
...
settings.binByN=10; % how much to down-sample tbt in time
...
% Whether to fixed time bins for histograms, or just use time bins emerging
