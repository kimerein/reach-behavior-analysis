...
% If is running on Harvard O2 server, set to 1
...
<<<<<<< HEAD
settings.blockITIThresh=[50]; % boundaries between ITI block lengths, in seconds
=======
...
settings.useFixedTimeBins=1; % 1 if yes, 0 if no
